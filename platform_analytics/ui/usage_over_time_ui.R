    ...
    fluidRow(
      sidebarLayout(
        ...
        mainPanel(
          ...
          hr(style="border-top: 1px solid #000000;"),
          # plotOutput("uot_plot", height = "700px", width = "100%"),
          # br(),br(),
          # h4('Average Session Duration Over Time Plot'),
          # hr(style="border-top: 1px solid #000000;"),
          # plotOutput("uot_asd_plot", height = "700px", width = "100%"),
          # br(),br(),
          # h4('Average Events Per User Over Time Plot'),
          # hr(style="border-top: 1px solid #000000;"),
          # plotOutput("uot_aeu_plot", height = "700px", width = "100%"),
          # br(),br(),
