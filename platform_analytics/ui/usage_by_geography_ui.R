tabPanel(
  ...
  # absolutePanel(id = 'ubg_controls', class = 'panel panel-default',
  #               top = 120, right = 20, width = 250, fixed = TRUE,
  ...
  # tabsetPanel(id = 'ubg_map_tabs',
  #             tabPanel(title = 'Heat Map', value = 'heatmap',
  #                      leafletOutput("ubg_heatmap", width = "100%", height = "100%") %>%
  #                        withSpinner(type = 3, color = '#2C3E50', color.background = '#ffffff')),
  #             tabPanel(title = 'Dot Chart', value = 'dotchart',
  #                      leafletOutput("ubg_dotchart", width = "100%", height = "100%") %>%
  #                        withSpinner(type = 3, color = '#2C3E50', color.background = '#ffffff')))
  # 
